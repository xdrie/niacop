    ...
    public class TimeMachineRunner : Runner<TimeMachineRunner.Options> {
        ...
        public class Options {
            ...
            [Option('p', "period", Required = false,
                HelpText = "The period of time (in hours) to show usage summary for.")]
            public float period { get; set; } = 1f; // hours

            [Option('r', "range", Required = false,
                HelpText = "The time range (in hours) to look for sessions in for rough-matching.")]
